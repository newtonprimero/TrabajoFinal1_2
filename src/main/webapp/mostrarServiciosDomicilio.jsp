                        ...
                        <div class="pcoded-content">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-8">
                                            <div class="page-header-title">
                                                <h5 class="m-b-10">Mostrar Servicios</h5>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <span>Vista de <code>servicios</code> de visita a domicilio.</span>
                                            ...
                                            <tbody>
                                                <c:forEach var="servicio" items="${listaServicios}" varStatus="status">
                                                    <tr>
                                                        ...
                                                        <td>${servicio.getHorario().getTecnico().getNombres()} ${servicio.getHorario().getTecnico().getApellidos()}</td>
                                                        <td>${servicio.getHorario().getFecha()} ${servicio.getHorario().getHoraini()}-${servicio.getHorario().getHorafin()}</td>
                                                        ...
                                                        <td>
                                                            <c:choose>
                                                                <c:when test="${servicio.estado_activ == true}">
                                                                    ...
                                                                    <a id="desactivarUsuario" href="ServletValidar?cambiar2=desactivar&cod=${servicio.id_servicio}" >
                                                                    ...
                                                                    <c:otherwise>
                                                                    <input type="hidden" id="item" value="${servicio.id_servicio}">
                                                                    <a id="activarUsuario" href="ServletValidar?cambiar2=activar&cod=${servicio.id_servicio}">
