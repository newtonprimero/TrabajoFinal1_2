                                        ...
                                        <div class="row">
                                            <div class="card-block">
                                                ...
                                                <a href="ServletHorarios?btnBuscar=horariosManana">
                                                    <button type="button" class="btn btn-primary waves-effect waves-light fa fa-calendar" data-toggle="modal" data-target="#staticBackdrop"  title="Seleccionar" data-original-title="Seleccionar" style="background: #771A1A; border-color: #771A1A;"> Mañana</button>
                                                </a>
