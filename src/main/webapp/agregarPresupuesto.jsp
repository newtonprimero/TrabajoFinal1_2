                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-8">
                                            <div class="page-header-title">
                                                <h5 class="m-b-10">Asignacion de Presupuesto</h5>
                                                <p class="m-b-0">Agrege los repuestos que se van a utilizar.</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                            ...
                            <div class="pcoded-inner-content">
                                ...
                                <div class="main-body">
                                    <div class="page-wrapper">
                                        <form action="ServletValidar?accion=nuevoRepuestoAsig" class="form-material" novalidate method="post">
                                            <!-- Page body start -->
                                            <div class="page-body">
                                                <div class="row">
                                                    <div class="col-sm-7">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <a href="<c:url value="ServletValidar">
                                                                                               <c:param name="accion" value="buscarRepuestoAsig" />
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-sm-8">
                                                                        ...
                                                                        <div class="form-group form-default">
                                                                            <input type="hidden" name="txtidServi" value="${servicio.cita.id_cita}">
                                                            ...
                                                            <div class="card-block table-border-style">
                                                                <div class="table-responsive">
                                                                    ...
                                                                    <div class="row col-sm-12" style="text-align: right;">
                                                                        ...
                                                                        <input type="hidden" name="txttotal" value="${totalpagar}">
                                                                        <input type="text" name="txtTotal" class="form-control col-sm-2" value="${totalpagar}" placeholder="col" disabled>
                                                                    </div>
                                                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end " style="margin-top: 4px;">
                                                                        ...
                                                                        <a href="ServletValidar?accion=nuevoRepuestoAsig&shear=procesar" class=" col align-self-end btn btn-success col-sm-3">Procesar</a> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
