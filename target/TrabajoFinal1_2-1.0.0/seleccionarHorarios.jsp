                        ...
                        <div class="pcoded-content">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-8">
                                            <div class="page-header-title">
                                                <h5 class="m-b-10">Solicitud & Servicios</h5>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5>Seleccione su hora de visita</h5>
                                    <span>Los horarios se muestra hasta <code>2 dias</code> despues de la fecha actual.</span>
                                            ...
                                            <tbody>
                                                <c:forEach var="hora" items="${listahoraselct}" varStatus="status">
                                                    <tr>
                                                        ...
                                                        <td>${hora.tecnico.nombres} ${hora.tecnico.apellidos}</td>
                                                        <td>${hora.fecha}</td>
                                                        <td>${hora.horaini}</td>
                                                        <td>${hora.horafin}</td>
                                                        ...
                                                        <c:if test="${hora.estado_activ == false}">
                                                            <td><span class="badge bg-red active" style="color: #000;background: #dc3545">No Disponible</span></td>
                                                        </c:if>
                                                        <td>
