                            ...
                            <div class="pcoded-inner-content">
                                ...
                                <div class="main-body">
                                    <div class="page-wrapper">
                                        <form action="ServletValidar?accion=nuevoRepuesto" class="form-material" novalidate method="post">
                                            <!-- Page body start -->
                                            <div class="page-body">
                                                <div class="row">
                                                    <div class="col-sm-7">
                                                            ...
                                                            <div class="card-block table-border-style">
                                                                <div class="table-responsive">
                                                                    ...
                                                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end " style="margin-top: 4px;">
                                                                        ...
                                                                        <a href="ServletValidar?accion=nuevoRepuesto&shear=procesar" class=" col align-self-end btn btn-success col-sm-3">Procesar</a> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
