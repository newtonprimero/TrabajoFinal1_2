                        ...
                        <div class="pcoded-content">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <span>Visualice de<code> servicios por Cliente</code> Generacion de reporte.</span>
                                </div>
                                <div class="col-sm-12 mobile-inputs">
                                    <form action="ServletGenerarReportes?btnIngresar=mostrarResulFiltros" method="post">
                                ...
                                <div class="card-block">
                                    <a href="ServletGenerarReportes?btnIngresar=reporteporClienteFiltro" target="_blank">
                                            ...
                                            <tbody>
                                                <c:forEach var="hora" items="${listaServicios}" varStatus="status">
                                                    <tr>
                                                        ...
                                                        <td>${hora.tenico.nombres} ${hora.tenico.apellidos}</td>
