                        ...
                        <div class="pcoded-content">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5>Hojas de Servicio</h5>
                                    <span>Visualizacion de <code>hojas</code> de servicio de atencion a domicilio.</span>
                                ...
                                <div class="card-block table-border-style">
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <c:forEach var="cliente" items="${listarHojas}" varStatus="status">
                                                    <tr>
                                                        <td>${status.index + 1}</td>
                                                        <td>${cliente.getServicio().getId_servicio()}</td>
                                                        <td>${cliente.getServicio().getTenico().nombres} ${cliente.getServicio().getTenico().apellidos}</td>
                                                        <td>${cliente.getServicio().getHorario().getFecha()}</td>
