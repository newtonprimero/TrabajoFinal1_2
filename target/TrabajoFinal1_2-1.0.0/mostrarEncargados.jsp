                        ...
                        <div class="pcoded-content">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-8">
                                            <div class="page-header-title">
                                                <h5 class="m-b-10">Mantenimiento Encargados</h5>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5>Encargados</h5>
                                    <span>Mantenimiento de <code>encargados</code> del taller</span>
                                ...
                                <div class="card-block table-border-style">
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <c:forEach var="encargado" items="${listaEncargado}" varStatus="status">
                                                    <tr>
                                                        <td>${status.index + 1}</td>
                                                        <td>${encargado.nombres} ${encargado.apellidos}</td>
                                                        <td>${encargado.dni}</td>
                                                        <td>${encargado.direccion}</td>
                                                        <td>${encargado.telefono1}${encargado.telefono2}</td>
                                                        <td>${encargado.correo}</td>
                                                        <td>${encargado.especialidad}</td>
                                                        <c:if test="${encargado.estado_activ == true}">
                                                            <td><span class="badge bg-green active" style="color: #000;background: #198754">Encargado Activo </span></td>
                                                        </c:if>
                                                        <c:if test="${encargado.estado_activ == false}">
                                                            <td><span class="badge bg-red active"style="color: #000;background: #dc3545">Encargado Inagtivo </span></td>
                                                        </c:if>
                                                        <td>${encargado.fecha_hora}</td>
