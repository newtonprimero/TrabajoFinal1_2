                ...
                <div class="pcoded-main-container">
                    <div class="pcoded-wrapper">
                        ...
                        <div class="pcoded-content">
                            ...
                            <%@include file="cabecera/cabecerareportes.jsp" %>
                            <!-- Page-header end -->

                            <div class="card">
                                <div class="card-header">
                                    <h5>Generar Reporte</h5>
                                    <span>Visualice de<code> servicios por tecnico</code> y generar Reporte.</span>
                                </div>
                                <div class="col-sm-12 mobile-inputs">
                                    <form action="ServletGenerarReportes?btnIngresar=mostrarResulFiltrosTecnico" method="post">
                                        <div class="card-block">
                                            <div class="form-group  row">
                                                <div class="col-sm-4" >
                                                    <label class="" >Fecha inicio:</label> 
                                                    <input type="date" name="inputfechaini" class="form-control col-sm-8"
                                                           required="">
                                                </div>
                                                <div class="col-sm-4" >
                                                    <label class="" >Fecha Fin:</label> 
                                                    <input type="date" name="inputfechafin" class="form-control col-sm-8"
                                                           required="">
                                                </div>
                                                <div class="col-sm-4" >
                                                    <button type="submit" class="btn btn-primary waves-effect waves-light"  style="background: #771A1A; border-color: #771A1A; margin-top: 30px">Filtrar</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="card-block">
                                    <a href="ServletGenerarReportes?btnIngresar=reporteporTecnicoFiltro" target="_blank">
                                        <button type="button" class="btn btn-primary waves-effect waves-light fa fa-file-pdf-o" data-toggle="modal" data-target="#staticBackdrop"  title="Imprimir" aria-hidden="true" data-original-title="Imprimir" style="background: #771A1A; border-color: #771A1A;"> Imprimir</button>
                                    </a>
                                </div>
                                <div class="card-block table-border-style">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered" id="examplerr">
                                            ...
                                            <tbody>
                                                <c:forEach var="hora" items="${listaServicios}" varStatus="status">
                                                    <tr>
                                                        <td>${status.index + 1}</td>
                                                        <td>${hora.getCita().perso.nombres} ${hora.getCita().perso.apellidos}</td>
