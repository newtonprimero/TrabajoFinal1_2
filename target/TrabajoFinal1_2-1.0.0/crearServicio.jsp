                        ...
                        <div class="pcoded-content">
                            ...
                            <div class="col-md-12">
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-sm-7">
                                            <form class="md-float-material form-material" action="ServletValidar?accion=registrarCitaTaller" method="post">
                                                <div class="auth-box card">
                                                    <div class="card-block">
                                                        ...
                                                        <div class="form-group form-static-label">
                                                            <input id="prodId" name="txridper" type="hidden" value="${cliente.id_client}">
                                                            <input type="text" name="txtnombres" class="form-control"
                                                                   required="" disabled value="${cliente.nombres}">
                                                            <span class="float-label"></span>
                                                            <label class="float-label">Nombres</label>
                                                        </div>
                                                        <div class="form-group form-static-label">
                                                            <input type="text" name="txtapellidos" class="form-control"
                                                                   required="" value="${cliente.apellidos}" disabled>
                                                        ...
                                                        <div class="form-group form-static-label">
                                                            ...
                                                            <span class="form-bar"></span>
                                                            <label class="float-label">Telefono</label>
                                                        </div>
                                                            <input type="hidden" name="cbodistrito" value="${cliente.distrit.id_distrito}">
                                                            <input type="hidden" name="txtdireccion" value="${cliente.direccion}">
                                                        ...
                                                        <h4 class="sub-title">Seleccione de Fecha de Diagnostico</h4>
                                                        <div class="form-group form-primary">
                                                            <div class="form-group col-sm-10" >
                                                                ...
                                                                <input type="datetime-local" name="inputfecha" class="form-control col-sm-6"
                                                                       required="">
                                                                <span class="form-bar">La hora seleccionada se le llamara para dar el presupuesto.</span>
                                                            </div>
                                                        </div> 
                                                        <div class="form-group form-primary row">
                                                            <div class="form-group col-sm-6" >
                                                                <input type="number" step="0.01" name="txtpresupuesto" class="form-control"
                                                                       required="" value="0.0" placeholder="0.0">
                                                                <span class="form-bar">Presupuesto</span>
                                                                <label class="float-label" style="margin-left:15px ;"></label>   
                                                            </div>
                                                        </div>
                                                        <div class="row m-t-30">
                                                            <div class="col-md-6">
                                                                <a href="ServletValidar?accion=atencionTaller">
                                                                    <button type="button"
                                                                            class="btn btn-danger btn-md btn-block waves-effect text-center m-b-20" name="btnRegistrar" value="Registrar">Cancelar</button>
                                                                </a>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <button type="submit"
