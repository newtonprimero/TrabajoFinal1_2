            ...
            <div class="pcoded-inner-navbar main-menu">
                ...
                <ul class="pcoded-item pcoded-left-item">
                    <li class="" id="iluminar">
                        <a href="homeCliente.jsp" class="waves-effect waves-dark">
                    ...
                    <li class="pcoded-hasmenu">
                        <a href="javascript:void(0)" class="waves-effect waves-dark">
                            ...
                            <span class="pcoded-mtext"
                                data-i18n="nav.basic-components.main">Solicitud &amp; Servicios</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                        <ul class="pcoded-submenu">
                            ...
                            <li class="" id="iluminar">
                                <a href="ServletValidar?accion=mostrarformcita" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    <span class="pcoded-mtext"
                                        data-i18n="nav.basic-components.alert">Generar Solicitud</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>
                            <li class=" " id="iluminar">
                                <a href="mostrarClientes.jsp" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    <span class="pcoded-mtext"
                                        data-i18n="nav.basic-components.breadcrumbs">Asistencia online</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>
                ...
                <div class="pcoded-navigation-label" data-i18n="nav.category.forms">Mostrar mis Actividades</div>
                <ul class="pcoded-item pcoded-left-item">
                    <li id="iluminar">
                        <a href="asignacionHorarios.jsp" class="waves-effect waves-dark">
                            <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                            <span class="pcoded-mtext" data-i18n="nav.form-components.main">Ultimo Servicio</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                    <li id="iluminar">
