                    ...
                    <div class="pcoded-content">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Actualizar datos de Técnico</h5>
                        ...
                        <div class="col-md-12">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <form class="md-float-material form-material" action="ServletValidar?accion=actualizarTecnico" method="post">
                                            <div class="auth-box card">
                                                <div class="card-block">
                                                    ...
                                                    <input type="hidden" name="txtiptecnic" value="${tecnico.id_tecn}">
                                                    <div class="form-group form-primary">
                                                        <input type="text" name="txtnombres" class="form-control"
                                                               required="" value="${tecnico.nombres}">
                                                        <span class="form-bar"></span>
                                                        <label class="float-label">Nombres</label>
                                                    </div>
                                                    <div class="form-group form-primary">
                                                        <input type="text" name="txtapellidos" class="form-control"
                                                            required="" value="${tecnico.apellidos}">
                                                        <span class="form-bar"></span>
                                                    ...
                                                    <div class="form-group form-primary">
                                                        <input type="text" name="txtdireccion" class="form-control"
                                                            required="" value="${tecnico.direccion}">
                                                        <span class="form-bar"></span>
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="form-group form-primary">
                                                                <input type="password" name="txtpassword"
                                                                    class="form-control" required="" value="${tecnico.password}">
                                                                <span class="form-bar"></span>
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="<c:url value="ServletValidar">
                                                                    <c:param name="accion" value="listartecnicos" />
                                                                    </c:url>">
